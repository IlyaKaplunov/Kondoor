...
const popupLinks = document.querySelectorAll('.wardrobe__img');
...
const popupSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".popup__slider", {
  slidesPerView: 1,
  speed: 600,
  loop: true,
  navigation: {
...
const finishingSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".finishing__slider", {
  slidesPerView: 1,
  spaceBetween: 25,
  speed: 600,
  loop: true,
